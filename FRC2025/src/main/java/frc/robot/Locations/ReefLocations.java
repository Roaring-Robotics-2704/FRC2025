...
public class ReefLocations {
    public static final Pose2d FL_Left = new Pose2d(3.073, 5.06, Rotation2d.fromDegrees(-60));
    public static final Pose2d FL_Right = new Pose2d(3.987, 5.224, Rotation2d.fromDegrees(-60));
    ...
    public static final Pose2d F_Left = new Pose2d(3.2, 4.19, Rotation2d.fromRadians(0));
    ...
    public static final Pose2d B_Left = new Pose2d(5.778, 3.826, Rotation2d.fromDegrees(180));
