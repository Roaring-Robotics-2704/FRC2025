...
public class ElevatorVisualizer {
    ...
    public ElevatorVisualizer(String key, Color color) {
        ...
        this.root = panel.getRoot(
                "elevator", Inches.of(7.35).in(Meters), Inches.of(10).in(Meters));
        this.elevator =
                root.append(new MechanismLigament2d("Elevator", Inches.of(0).in(Meters), 45, 10, new Color8Bit(color)));
