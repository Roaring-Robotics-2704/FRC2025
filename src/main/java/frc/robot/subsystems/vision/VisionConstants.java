...
public class VisionConstants {
    ...
    public static final Transform3d robotToCamera0 = new Transform3d( // Front Camera
            Units.inchesToMeters(28 / 2),
            Units.inchesToMeters((28 / 2) - (11 - (1 / 16))),
            Units.inchesToMeters(11 + (7 / 8)),
            new Rotation3d(0.0, -Units.degreesToRadians(0), 0.0));
    public static final Transform3d robotToCamera1 = new Transform3d( // Back Camera
            -Units.inchesToMeters((28 / 2) - (3 / 16)),
            -Units.inchesToMeters((28 / 2) - (13 + (7 / 8))),
            Units.inchesToMeters(32 + (3 / 8)),
    ...
    public static final double angularStdDevBaseline = Units.degreesToRadians(3); // Radians
