...
import frc.robot.commands.autonomous.CoralAuto;
...
public class RobotContainer {
        ...
        public RobotContainer() {
                switch (Constants.CURRENT_MODE) {
                        case REAL -> {
                                ...
                                drive = new Drive(
                                                ...
                                                new ModuleIOSpark(2),
                                                new ModuleIOSpark(3));
                                pathBuilder = new Pathbuilder(drive);
                        ...
                        case SIM -> {
                                ...
                                vision = new Vision(
                                                ...
                                                new VisionIOPhotonVisionSim(
                                                                CAMERA_0_NAME, robotToCamera0,
                                                                driveSimulation::getSimulatedDriveTrainPose),
                                                new VisionIOPhotonVisionSim(
                                                                CAMERA_1_NAME, robotToCamera1,
                                                                driveSimulation::getSimulatedDriveTrainPose));
                        }
                        default -> {
                ...
                autoChooser = new LoggedDashboardChooser<>(
                                ...
                                AutoBuilder.buildAutoChooserWithOptionsModifier(
                                                stream -> Boolean.TRUE.equals(Constants.COMPETITION)
        ...
        public Command getAutonomousCommand() {
                return new CoralAuto().getCommand();
        }
