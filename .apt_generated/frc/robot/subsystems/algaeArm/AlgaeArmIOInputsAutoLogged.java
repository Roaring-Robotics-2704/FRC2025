...
public class AlgaeArmIOInputsAutoLogged extends AlgaeArmIO.AlgaeArmIOInputs implements LoggableInputs, Cloneable {
    ...
    public void toLog(LogTable table) {
        table.put("AlgaePivotPositionDeg", algaePivotPositionDeg);
    ...
    public void fromLog(LogTable table) {
        algaePivotPositionDeg = table.get("AlgaePivotPositionDeg", algaePivotPositionDeg);
    ...
    public AlgaeArmIOInputsAutoLogged clone() {
        ...
        copy.algaePivotPositionDeg = this.algaePivotPositionDeg;
